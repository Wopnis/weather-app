const urlTest = '../data.json';
const url = 'http://api.openweathermap.org/data/2.5/forecast?id=625144&units=metric&lang=ru&appid=340c7631b5688be9a743e351a44694db'; //for Minsk, BY
...
async function getData() {
  ...
  if (response.ok) {
    ...
    alert('Ошибка получения данных: ' + response.status);
  }
};
